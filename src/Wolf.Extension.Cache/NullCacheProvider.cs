...
namespace Wolf.Extension.Cache
{
    ...
    public class NullCacheProvider : ICacheProvider
    {
        ...
        public bool Set(IEnumerable<BaseRequest<string>> list, TimeSpan? expiry = null, PersistentOps persistentOps = null)
        {
            throw new NotImplementedException();
        }
        ...
        public bool Set<T>(IEnumerable<BaseRequest<T>> list, TimeSpan? expiry = null, PersistentOps persistentOps = null)
        {
            throw new NotImplementedException();
        }
        ...
        public Task<bool> SetAsync(string key, string value, TimeSpan? expiry = null, PersistentOps persistentOps = null)
        {
            throw new NotImplementedException();
        }

        public Task<bool> SetAsync(List<BaseRequest<string>> list, TimeSpan? expiry = null, PersistentOps persistentOps = null)
        {
            throw new NotImplementedException();
        }

        public Task<bool> SetAsync<T>(string key, T obj, TimeSpan? expiry = null, PersistentOps persistentOps = null)
        {
            throw new NotImplementedException();
        }

        public Task<bool> SetAsync<T>(List<BaseRequest<T>> list, TimeSpan? expiry = null, PersistentOps persistentOps = null)
        {
            throw new NotImplementedException();
        }
