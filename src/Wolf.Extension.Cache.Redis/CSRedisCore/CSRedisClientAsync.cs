    ...
    public partial class CSRedisClient
    {
        ...
        async Task<AutoPipe> GetClientAsync(RedisClientPool pool)
        {
            if (pool._policy._asyncPipeline == false)
                return new AutoPipe
                    {Client = await pool.GetAsync(), GetTimes = 1, TimesZore = 0, IsSingleEndPipe = false};

            if (_autoPipe.TryGetValue(pool.Key, out var ap) && ap.IsSingleEndPipe == false)
            {
                if (pool.UnavailableException != null)
                    throw new Exception(
                        $"【{pool._policy.Name}】状态不可用，等待后台检查程序恢复方可使用。{pool.UnavailableException?.Message}",
        ...
        async Task<T> GetAndExecuteAsync<T>(RedisClientPool pool, Func<Object<RedisClient>, Task<T>> handerAsync,
            int jump = 100, int errtimes = 0)
        {
            AutoPipe ap = null;
        ...
        /// <param name="getDataAsync">获取源数据的函数</param>
        /// <returns></returns>
        async public Task<T> CacheShellAsync<T>(string key, string field, int timeoutSeconds,
            Func<Task<T>> getDataAsync)
        {
            ...
            var ret = await getDataAsync();
            await HSetAsync(key, field,
                this.SerializeObject((ret, (long) DateTime.Now.Subtract(_dt1970).TotalSeconds)));
            return ret;
        }
        ...
        async private Task<T[]> ExecuteArrayAsync<T>(string[] key,
            Func<Object<RedisClient>, string[], Task<T[]>> handerAsync)
        {
        ...
        async private Task<long> ExecuteNonQueryAsync(string[] key,
            Func<Object<RedisClient>, string[], Task<long>> handerAsync)
        {
        ...
        public partial class NodesServerManagerProvider
        {
            ...
            /// </summary>
            /// <returns></returns>
            public Task<(string node, string value)[]> BgRewriteAofAsync() =>
                NodesInternalAsync(c => c.Value.BgRewriteAofAsync());
            ...
            /// </summary>
            /// <returns></returns>
            public Task<(string node, string value)[]> ClientListAsync() =>
                NodesInternalAsync(c => c.Value.ClientListAsync());

            /// <summary>
            /// 获取连接的名称
            /// </summary>
            /// <returns></returns>
            public Task<(string node, string value)[]> ClientGetNameAsync() =>
                NodesInternalAsync(c => c.Value.ClientGetNameAsync());
            ...
            public Task<(string node, Dictionary<string, string> value)[]> ConfigGetAsync(string parameter) =>
                NodesInternalAsync(async c =>
                    (await c.Value.ConfigGetAsync(parameter)).ToDictionary(z => z.Item1, y => y.Item2));

            /// <summary>
            /// 对启动 Redis 服务器时所指定的 redis.conf 配置文件进行改写
            /// </summary>
            /// <returns></returns>
            public Task<(string node, string value)[]> ConfigRewriteAsync() =>
                NodesInternalAsync(c => c.Value.ConfigRewriteAsync());
            ...
            /// </summary>
            /// <returns></returns>
            public Task<(string node, string value)[]> DebugSegFaultAsync() =>
                NodesInternalAsync(c => c.Value.DebugSegFaultAsync());

            /// <summary>
            /// 删除所有数据库的所有key
            /// </summary>
            /// <returns></returns>
            public Task<(string node, string value)[]> FlushAllAsync() =>
                NodesInternalAsync(c => c.Value.FlushAllAsync());

            /// <summary>
            /// 删除当前数据库的所有key
            /// </summary>
            /// <returns></returns>
            public Task<(string node, string value)[]> FlushDbAsync() =>
                NodesInternalAsync(c => c.Value.FlushDbAsync());
            ...
            /// </summary>
            /// <returns></returns>
            public Task<(string node, DateTime value)[]> LastSaveAsync() =>
                NodesInternalAsync(c => c.Value.LastSaveAsync());
            ...
            /// </summary>
            /// <returns></returns>
            public Task<(string node, string value)[]> SlaveOfNoOneAsync() =>
                NodesInternalAsync(c => c.Value.SlaveOfNoOneAsync());
            ...
            /// </summary>
            /// <returns></returns>
            public Task<(string node, long value)[]> SlowLogLenAsync() =>
                NodesInternalAsync(c => c.Value.SlowLogLenAsync());

            /// <summary>
            /// 管理 redis 的慢日志，清空
            /// </summary>
            /// <returns></returns>
            public Task<(string node, string value)[]> SlowLogResetAsync() =>
                NodesInternalAsync(c => c.Value.SlowLogResetAsync());
        ...
        public partial class NodeServerManagerProvider
        {
            ...
            /// <param name="skipMe">跳过自己</param>
            /// <returns></returns>
            public Task<long> ClientKillAsync(string addr = null, string id = null, ClientKillType? type = null,
                bool? skipMe = null) => _csredis.GetAndExecute(_pool,
                c => c.Value.ClientKillAsync(addr, id, type?.ToString(), skipMe));
            ...
            public Task<string> ClientGetNameAsync() =>
                _csredis.GetAndExecute(_pool, c => c.Value.ClientGetNameAsync());
            ...
            async public Task<Dictionary<string, string>> ConfigGetAsync(string parameter) =>
                (await _csredis.GetAndExecute(_pool, c => c.Value.ConfigGetAsync(parameter))).ToDictionary(z => z.Item1,
                    y => y.Item2);
            ...
            public Task<string> ConfigRewriteAsync() =>
                _csredis.GetAndExecute(_pool, c => c.Value.ConfigRewriteAsync());
            ...
            public Task<string> ConfigResetStatAsync() =>
                _csredis.GetAndExecute(_pool, c => c.Value.ConfigResetStatAsync());
            ...
            public Task<string> DebugSegFaultAsync() =>
                _csredis.GetAndExecute(_pool, c => c.Value.DebugSegFaultAsync());
        ...
        public Task<string> EchoAsync(string message) =>
            GetAndExecuteAsync(Nodes.First().Value, c => c.Value.EchoAsync(message));
        ...
        /// <param name="nodeKey">分区key</param>
        /// <returns></returns>
        public Task<bool> PingAsync(string nodeKey) => GetAndExecuteAsync(GetNodeOrThrowNotFound(nodeKey),
            async c => await c.Value.PingAsync() == "PONG");
        ...
        public Task<bool> PingAsync() =>
            GetAndExecuteAsync(Nodes.First().Value, async c => await c.Value.PingAsync() == "PONG");
        ...
        /// <returns></returns>
        [Obsolete("不建议手工执行，连接池自己管理最佳")]
        private Task<bool> QuitAsync(string nodeKey) => GetAndExecuteAsync(GetNodeOrThrowNotFound(nodeKey),
            async c => await c.Value.QuitAsync() == "OK");
        ...
        private Task<bool> SelectAsync(string nodeKey, int index) => GetAndExecuteAsync(GetNodeOrThrowNotFound(nodeKey),
            async c => await c.Value.SelectAsync(index) == "OK");
        ...
        async public Task<bool[]> ScriptExistsAsync(params string[] sha1)
        {
            ...
            foreach (var pool in Nodes.Values)
                ret.Add((await GetAndExecuteAsync(pool, c => c.Value.ScriptExistsAsync(sha1)))?.Where(z => z == false)
                    .Any() == false);
            return ret.ToArray();
        }
        ...
        public Task<long> PubSubNumPatAsync() =>
            GetAndExecuteAsync(Nodes.First().Value, c => c.Value.PubSubNumPatAsync());
        ...
        public Task<long> PfCountAsync(params string[] keys) =>
            NodesNotSupportAsync(keys, 0, (c, k) => c.Value.PfCountAsync(k));
        ...
        /// <returns></returns>
        [Obsolete("分区模式下，若keys分散在多个分区节点时，将报错")]
        public Task<bool> PfMergeAsync(string destKey, params string[] sourceKeys) => NodesNotSupportAsync(
        ...
        async public Task<(string member, decimal score)[]> ZPopMaxAsync(string key, long count) =>
            (await ExecuteScalarAsync(key, (c, k) => c.Value.ZPopMaxAsync(k, count))).Select(a => (a.Item1, a.Item2))
            .ToArray();
        ...
        async public Task<(T member, decimal score)[]> ZPopMaxAsync<T>(string key, long count) =>
            this.DeserializeRedisValueTuple1Internal<T, decimal>(await ExecuteScalarAsync(key,
        ...
        async public Task<(string member, decimal score)[]> ZPopMinAsync(string key, long count) =>
            (await ExecuteScalarAsync(key, (c, k) => c.Value.ZPopMinAsync(k, count))).Select(a => (a.Item1, a.Item2))
            .ToArray();
        ...
        /// <returns></returns>
        public Task<long> ZCountAsync(string key, decimal min, decimal max) => ExecuteScalarAsync(key,
        ...
        /// <param name="increment">增量值(默认=1)</param>
        /// <returns></returns>
        public Task<decimal> ZIncrByAsync(string key, object member, decimal increment = 1)
        {
            var args = this.SerializeRedisValueInternal(member);
            return ExecuteScalarAsync(key, (c, k) => c.Value.ZIncrByAsync(k, increment, args));
        }
        ...
        /// <returns></returns>
        public Task<long> ZInterStoreAsync(string destination, decimal[] weights, RedisAggregate aggregate,
            params string[] keys)
        {
        ...
        public Task<string[]> ZRangeAsync(string key, long start, long stop) =>
            ExecuteScalarAsync(key, (c, k) => c.Value.ZRangeAsync(k, start, stop, false));
        ...
        async public Task<T[]> ZRangeAsync<T>(string key, long start, long stop) =>
            this.DeserializeRedisValueArrayInternal<T>(await ExecuteScalarAsync(key,
                (c, k) => c.Value.ZRangeBytesAsync(k, start, stop, false)));
        ...
        async public Task<(string member, decimal score)[]> ZRangeWithScoresAsync(string key, long start, long stop) =>
            (await ExecuteScalarAsync(key, (c, k) => c.Value.ZRangeWithScoresAsync(k, start, stop)))
        ...
        /// <returns></returns>
        public Task<string[]> ZRangeByScoreAsync(string key, decimal min, decimal max, long? count = null,
            long offset = 0) =>
        ...
        /// <param name="offset">返回条件偏移位置</param>
        /// <returns></returns>
        async public Task<T[]> ZRangeByScoreAsync<T>(string key, decimal min, decimal max, long? count = null,
            long offset = 0) =>
            this.DeserializeRedisValueArrayInternal<T>(await ExecuteScalarAsync(key,
        ...
        /// <param name="offset">返回条件偏移位置</param>
        /// <returns></returns>
        public Task<string[]> ZRangeByScoreAsync(string key, string min, string max, long? count = null,
            long offset = 0) =>
        ...
        /// <param name="offset">返回条件偏移位置</param>
        /// <returns></returns>
        async public Task<T[]> ZRangeByScoreAsync<T>(string key, string min, string max, long? count = null,
            long offset = 0) =>
            this.DeserializeRedisValueArrayInternal<T>(await ExecuteScalarAsync(key,
        ...
        /// <param name="offset">返回条件偏移位置</param>
        /// <returns></returns>
        async public Task<(string member, decimal score)[]> ZRangeByScoreWithScoresAsync(string key, decimal min,
            decimal max, long? count = null, long offset = 0) =>
            (await ExecuteScalarAsync(key,
                (c, k) => c.Value.ZRangeByScoreWithScoresAsync(k, min == decimal.MinValue ? "-inf" : min.ToString(),
                    max == decimal.MaxValue ? "+inf" : max.ToString(), offset, count))).Select(z => (z.Item1, z.Item2))
            .ToArray();
        ...
        /// <param name="offset">返回条件偏移位置</param>
        /// <returns></returns>
        async public Task<(T member, decimal score)[]> ZRangeByScoreWithScoresAsync<T>(string key, decimal min,
            decimal max, long? count = null, long offset = 0) =>
            this.DeserializeRedisValueTuple1Internal<T, decimal>(await ExecuteScalarAsync(key,
                (c, k) => c.Value.ZRangeBytesByScoreWithScoresAsync(k,
                    min == decimal.MinValue ? "-inf" : min.ToString(),
        ...
        /// <param name="offset">返回条件偏移位置</param>
        /// <returns></returns>
        async public Task<(string member, decimal score)[]> ZRangeByScoreWithScoresAsync(string key, string min,
            string max, long? count = null, long offset = 0) =>
        ...
        /// <param name="offset">返回条件偏移位置</param>
        /// <returns></returns>
        async public Task<(T member, decimal score)[]> ZRangeByScoreWithScoresAsync<T>(string key, string min,
            string max, long? count = null, long offset = 0) =>
            this.DeserializeRedisValueTuple1Internal<T, decimal>(await ExecuteScalarAsync(key,
        ...
        /// <param name="max">分数最大值 decimal.MaxValue 10</param>
        /// <returns></returns>
        public Task<long> ZRemRangeByScoreAsync(string key, decimal min, decimal max) => ExecuteScalarAsync(key,
        ...
        public Task<string[]> ZRevRangeAsync(string key, long start, long stop) =>
            ExecuteScalarAsync(key, (c, k) => c.Value.ZRevRangeAsync(k, start, stop, false));
        ...
        async public Task<T[]> ZRevRangeAsync<T>(string key, long start, long stop) =>
            this.DeserializeRedisValueArrayInternal<T>(await ExecuteScalarAsync(key,
                (c, k) => c.Value.ZRevRangeBytesAsync(k, start, stop, false)));
        ...
        async public Task<(string member, decimal score)[]>
            ZRevRangeWithScoresAsync(string key, long start, long stop) =>
        ...
        /// <returns></returns>
        public Task<string[]>
            ZRevRangeByScoreAsync(string key, decimal max, decimal min, long? count = null, long? offset = 0) =>
            ExecuteScalarAsync(key,
        ...
        /// <param name="offset">返回条件偏移位置</param>
        /// <returns></returns>
        async public Task<T[]> ZRevRangeByScoreAsync<T>(string key, decimal max, decimal min, long? count = null,
            long offset = 0) =>
            this.DeserializeRedisValueArrayInternal<T>(await ExecuteScalarAsync(key,
        ...
        /// <param name="offset">返回条件偏移位置</param>
        /// <returns></returns>
        public Task<string[]> ZRevRangeByScoreAsync(string key, string max, string min, long? count = null,
            long? offset = 0) => ExecuteScalarAsync(key,
            (c, k) => c.Value.ZRevRangeByScoreAsync(k, max, min, false, offset, count));
        ...
        /// <param name="offset">返回条件偏移位置</param>
        /// <returns></returns>
        async public Task<T[]> ZRevRangeByScoreAsync<T>(string key, string max, string min, long? count = null,
            long offset = 0) =>
            this.DeserializeRedisValueArrayInternal<T>(await ExecuteScalarAsync(key,
        ...
        /// <param name="offset">返回条件偏移位置</param>
        /// <returns></returns>
        async public Task<(string member, decimal score)[]> ZRevRangeByScoreWithScoresAsync(string key, decimal max,
            decimal min, long? count = null, long offset = 0) =>
            (await ExecuteScalarAsync(key,
                (c, k) => c.Value.ZRevRangeByScoreWithScoresAsync(k, max == decimal.MaxValue ? "+inf" : max.ToString(),
                    min == decimal.MinValue ? "-inf" : min.ToString(), offset, count))).Select(z => (z.Item1, z.Item2))
            .ToArray();
        ...
        /// <param name="offset">返回条件偏移位置</param>
        /// <returns></returns>
        async public Task<(T member, decimal score)[]> ZRevRangeByScoreWithScoresAsync<T>(string key, decimal max,
            decimal min, long? count = null, long offset = 0) =>
            this.DeserializeRedisValueTuple1Internal<T, decimal>(await ExecuteScalarAsync(key,
                (c, k) => c.Value.ZRevRangeBytesByScoreWithScoresAsync(k,
                    max == decimal.MaxValue ? "+inf" : max.ToString(),
        ...
        /// <param name="offset">返回条件偏移位置</param>
        /// <returns></returns>
        async public Task<(string member, decimal score)[]> ZRevRangeByScoreWithScoresAsync(string key, string max,
            string min, long? count = null, long offset = 0) =>
            (await ExecuteScalarAsync(key,
                (c, k) => c.Value.ZRevRangeByScoreWithScoresAsync(k, max, min, offset, count)))
            .Select(z => (z.Item1, z.Item2)).ToArray();
        ...
        /// <param name="offset">返回条件偏移位置</param>
        /// <returns></returns>
        async public Task<(T member, decimal score)[]> ZRevRangeByScoreWithScoresAsync<T>(string key, string max,
            string min, long? count = null, long offset = 0) =>
            this.DeserializeRedisValueTuple1Internal<T, decimal>(await ExecuteScalarAsync(key,
        ...
        /// <param name="keys">一个或多个有序集合，不含prefix前辍</param>
        /// <returns></returns>
        public Task<long> ZUnionStoreAsync(string destination, decimal[] weights, RedisAggregate aggregate,
            params string[] keys)
        {
            if (keys == null || keys.Length == 0) throw new Exception("keys 参数不可为空");
            if (weights != null && weights.Length != keys.Length) throw new Exception("weights 和 keys 参数长度必须相同");
        ...
        /// <param name="count">数量</param>
        /// <returns></returns>
        async public Task<RedisScan<(string member, decimal score)>> ZScanAsync(string key, long cursor,
            string pattern = null, long? count = null)
        {
        ...
        /// <param name="count">数量</param>
        /// <returns></returns>
        async public Task<RedisScan<(T member, decimal score)>> ZScanAsync<T>(string key, long cursor,
            string pattern = null, long? count = null)
        {
        ...
        /// <param name="offset">返回条件偏移位置</param>
        /// <returns></returns>
        public Task<string[]> ZRangeByLexAsync(string key, string min, string max, long? count = null,
            long offset = 0) =>
        ...
        /// <param name="offset">返回条件偏移位置</param>
        /// <returns></returns>
        async public Task<T[]> ZRangeByLexAsync<T>(string key, string min, string max, long? count = null,
            long offset = 0) =>
            this.DeserializeRedisValueArrayInternal<T>(await ExecuteScalarAsync(key,
        ...
        async public Task<T[]> SDiffAsync<T>(params string[] keys) =>
            this.DeserializeRedisValueArrayInternal<T>(await NodesNotSupportAsync(keys, new byte[0][],
        ...
        /// <returns></returns>
        public Task<long> SDiffStoreAsync(string destination, params string[] keys) => NodesNotSupportAsync(
        ...
        /// <param name="keys">一个或多个无序集合，不含prefix前辍</param>
        /// <returns></returns>
        public Task<long> SInterStoreAsync(string destination, params string[] keys) => NodesNotSupportAsync(
            new[] {destination}.Concat(keys).ToArray(), 0,
        ...
        async public Task<T[]> SMembersAsync<T>(string key) =>
            this.DeserializeRedisValueArrayInternal<T>(await ExecuteScalarAsync(key,
                (c, k) => c.Value.SMembersBytesAsync(k)));
        ...
        async public Task<T> SPopAsync<T>(string key) =>
            this.DeserializeRedisValueInternal<T>(await ExecuteScalarAsync(key, (c, k) => c.Value.SPopBytesAsync(k)));
        ...
        public Task<string[]> SPopAsync(string key, long count) =>
            ExecuteScalarAsync(key, (c, k) => c.Value.SPopAsync(k, count));
        ...
        async public Task<T[]> SPopAsync<T>(string key, long count) =>
            this.DeserializeRedisValueArrayInternal<T>(await ExecuteScalarAsync(key,
                (c, k) => c.Value.SPopBytesAsync(k, count)));
        ...
        public Task<string> SRandMemberAsync(string key) =>
            ExecuteScalarAsync(key, (c, k) => c.Value.SRandMemberAsync(k));
        ...
        async public Task<T> SRandMemberAsync<T>(string key) =>
            this.DeserializeRedisValueInternal<T>(await ExecuteScalarAsync(key,
                (c, k) => c.Value.SRandMemberBytesAsync(k)));
        ...
        async public Task<T[]> SRandMembersAsync<T>(string key, int count = 1) =>
            this.DeserializeRedisValueArrayInternal<T>(await ExecuteScalarAsync(key,
                (c, k) => c.Value.SRandMembersBytesAsync(k, count)));
        ...
        /// <param name="keys">一个或多个无序集合，不含prefix前辍</param>
        /// <returns></returns>
        public Task<long> SUnionStoreAsync(string destination, params string[] keys) => NodesNotSupportAsync(
            new[] {destination}.Concat(keys).ToArray(), 0,
        ...
        /// <param name="count">数量</param>
        /// <returns></returns>
        async public Task<RedisScan<T>> SScanAsync<T>(string key, long cursor, string pattern = null,
            long? count = null)
        {
        ...
        public Task<string> LIndexAsync(string key, long index) =>
            ExecuteScalarAsync(key, (c, k) => c.Value.LIndexAsync(k, index));
        ...
        async public Task<T> LIndexAsync<T>(string key, long index) =>
            this.DeserializeRedisValueInternal<T>(await ExecuteScalarAsync(key,
                (c, k) => c.Value.LIndexBytesAsync(k, index)));
        ...
        async public Task<T> LPopAsync<T>(string key) =>
            this.DeserializeRedisValueInternal<T>(await ExecuteScalarAsync(key, (c, k) => c.Value.LPopBytesAsync(k)));
        ...
        async public Task<T[]> LRangeAsync<T>(string key, long start, long stop) =>
            this.DeserializeRedisValueArrayInternal<T>(await ExecuteScalarAsync(key,
                (c, k) => c.Value.LRangeBytesAsync(k, start, stop)));
        ...
        async public Task<T> RPopAsync<T>(string key) =>
            this.DeserializeRedisValueInternal<T>(await ExecuteScalarAsync(key, (c, k) => c.Value.RPopBytesAsync(k)));
        ...
        public Task<string> RPopLPushAsync(string source, string destination) =>
            NodesNotSupportAsync(new[] {source, destination}, null,
                (c, k) => c.Value.RPopLPushAsync(k.First(), k.Last()));
        ...
        async public Task<T> RPopLPushAsync<T>(string source, string destination) =>
            this.DeserializeRedisValueInternal<T>(await NodesNotSupportAsync(new[] {source, destination}, null,
        ...
        public Task<long> HStrLenAsync(string key, string field) =>
            ExecuteScalarAsync(key, (c, k) => c.Value.HStrLenAsync(k, field));
        ...
        /// <param name="fields">字段</param>
        /// <returns></returns>
        async public Task<long> HDelAsync(string key, params string[] fields) => fields == null || fields.Any() == false
            ? 0
        ...
        public Task<bool> HExistsAsync(string key, string field) =>
            ExecuteScalarAsync(key, (c, k) => c.Value.HExistsAsync(k, field));
        ...
        public Task<string> HGetAsync(string key, string field) =>
            ExecuteScalarAsync(key, (c, k) => c.Value.HGetAsync(k, field));
        ...
        async public Task<T> HGetAsync<T>(string key, string field) =>
            this.DeserializeRedisValueInternal<T>(await ExecuteScalarAsync(key,
                (c, k) => c.Value.HGetBytesAsync(k, field)));
        ...
        async public Task<Dictionary<string, T>> HGetAllAsync<T>(string key) =>
            this.DeserializeRedisValueDictionaryInternal<string, T>(
                await ExecuteScalarAsync(key, (c, k) => c.Value.HGetAllBytesAsync(k)));
        ...
        async public Task<T[]> HMGetAsync<T>(string key, params string[] fields) =>
            fields == null || fields.Any() == false
                ? new T[0]
                : this.DeserializeRedisValueArrayInternal<T>(await ExecuteScalarAsync(key,
                    (c, k) => c.Value.HMGetBytesAsync(k, fields)));
        ...
        /// <param name="count">数量</param>
        /// <returns></returns>
        async public Task<RedisScan<(string field, string value)>> HScanAsync(string key, long cursor,
            string pattern = null, long? count = null)
        {
        ...
        /// <param name="count">数量</param>
        /// <returns></returns>
        async public Task<RedisScan<(string field, T value)>> HScanAsync<T>(string key, long cursor,
            string pattern = null, long? count = null)
        {
        ...
        async public Task<T> GetAsync<T>(string key) =>
            this.DeserializeRedisValueInternal<T>(await ExecuteScalarAsync(key, (c, k) => c.Value.GetBytesAsync(k)));
        ...
        public Task<bool> GetBitAsync(string key, uint offset) =>
            ExecuteScalarAsync(key, (c, k) => c.Value.GetBitAsync(k, offset));
        ...
        async public Task<T> GetRangeAsync<T>(string key, long start, long end) =>
            this.DeserializeRedisValueInternal<T>(await ExecuteScalarAsync(key,
                (c, k) => c.Value.GetRangeBytesAsync(k, start, end)));
        ...
        {
            var args = this.SerializeRedisValueInternal(value);
            return this.DeserializeRedisValueInternal<T>(await ExecuteScalarAsync(key,
                (c, k) => c.Value.GetSetBytesAsync(k, args)));
        }
        ...
        public Task<long> IncrByAsync(string key, long value = 1) =>
            ExecuteScalarAsync(key, (c, k) => c.Value.IncrByAsync(k, value));
        ...
        public Task<string[]> MGetAsync(params string[] keys) =>
            ExecuteArrayAsync(keys, (c, k) => c.Value.MGetAsync(k));
        ...
        async public Task<T[]> MGetAsync<T>(params string[] keys) =>
            this.DeserializeRedisValueArrayInternal<T>(await ExecuteArrayAsync(keys,
                (c, k) => c.Value.MGetBytesAsync(k)));
        ...
        /// <returns></returns>
        async public Task<bool> SetAsync(string key, object value, int expireSeconds = -1,
            RedisExistence? exists = null)
        {
            ...
            if (expireSeconds > 0 && exists == null)
                return await ExecuteScalarAsync(key, (c, k) => c.Value.SetAsync(k, redisValule, expireSeconds, null)) ==
                       "OK";
            if (expireSeconds > 0 && exists != null)
                return await ExecuteScalarAsync(key,
                    (c, k) => c.Value.SetAsync(k, redisValule, expireSeconds, exists)) == "OK";
            return false;
        }
        ...
        async public Task<bool> SetAsync(string key, object value, TimeSpan expire, RedisExistence? exists = null)
        {
            ...
            if (expire > TimeSpan.Zero && exists == null)
                return await ExecuteScalar(key, (c, k) => c.Value.SetAsync(k, redisValule, expire, null)) == "OK";
            if (expire > TimeSpan.Zero && exists != null)
        ...
        /// <param name="key">不含prefix前辍</param>
        /// <returns></returns>
        public Task<long> UnLinkAsync(params string[] key) =>
            ExecuteNonQueryAsync(key, (c, k) => c.Value.UnLinkAsync(k));
        ...
        public Task<bool> ExpireAsync(string key, int seconds) =>
            ExecuteScalarAsync(key, (c, k) => c.Value.ExpireAsync(k, seconds));
        ...
        public Task<bool> MoveAsync(string key, int database) =>
            ExecuteScalarAsync(key, (c, k) => c.Value.MoveAsync(k, database));
        ...
        public Task<string> ObjectEncodingAsync(string key) =>
            ExecuteScalarAsync(key, (c, k) => c.Value.ObjectEncodingAsync(k));
        ...
        public Task<string> RandomKeyAsync() => GetAndExecuteAsync(Nodes[NodesIndex[_rnd.Next(0, NodesIndex.Count)]],
            async c =>
            {
        ...
        /// <param name="newKey">新名称，不含prefix前辍</param>
        /// <returns></returns>
        public Task<bool> RenameNxAsync(string key, string newKey) => NodesNotSupportAsync(new[] {key, newKey}, false,
            (c, k) => c.Value.RenameNxAsync(k.First(), k.Last()));
        ...
        /// <returns></returns>
        public Task<bool> RestoreAsync(string key, byte[] serializedValue) => ExecuteScalarAsync(key,
            async (c, k) => await c.Value.RestoreAsync(k, 0, serializedValue) == "OK");
        ...
        public Task<bool> RestoreAsync(string key, long ttlMilliseconds, byte[] serializedValue) =>
            ExecuteScalarAsync(key,
                async (c, k) => await c.Value.RestoreAsync(k, ttlMilliseconds, serializedValue) == "OK");
        ...
        /// <returns></returns>
        public Task<string[]> SortAsync(string key, long? count = null, long offset = 0, string by = null,
        ...
        /// <param name="get">根据排序的结果来取出相应的键值</param>
        /// <returns></returns>
        public Task<long> SortAndStoreAsync(string key, string destination, long? count = null, long offset = 0,
            string by = null, RedisSortDir? dir = null, bool? isAlpha = null, params string[] get) =>
            NodesNotSupportAsync(key,
                (c, k) => c.Value.SortAndStoreAsync(k, (c.Pool as RedisClientPool)?.Prefix + destination, offset, count,
                    by, dir, isAlpha, get));
        ...
        {
            var scan = await NodesNotSupportAsync("ScanAsync<T>",
                (c, k) => c.Value.ScanBytesAsync(cursor, pattern, count));
            return new RedisScan<T>(scan.Cursor, this.DeserializeRedisValueArrayInternal<T>(scan.Items));
        }
        ...
        async public Task<long> GeoAddAsync(string key,
            params (decimal longitude, decimal latitude, object member)[] values)
        {
        ...
        async public Task<string[]> GeoRadiusAsync(string key, decimal longitude, decimal latitude, decimal radius,
            ...
            (await ExecuteScalarAsync(key,
                (c, k) => c.Value.GeoRadiusAsync(k, longitude, latitude, radius, unit, count, sorting, false, false,
                    false))).Select(a => a.member).ToArray();
        ...
        async public Task<T[]> GeoRadiusAsync<T>(string key, decimal longitude, decimal latitude, decimal radius,
            GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null) =>
            (await ExecuteScalarAsync(key,
                (c, k) => c.Value.GeoRadiusBytesAsync(k, longitude, latitude, radius, unit, count, sorting, false,
                    false, false))).Select(a => this.DeserializeRedisValueInternal<T>(a.member)).ToArray();
        ...
        /// <param name="sorting">排序</param>
        /// <returns></returns>
        async public Task<(string member, decimal dist)[]> GeoRadiusWithDistAsync(string key, decimal longitude,
            ...
            (await ExecuteScalarAsync(key,
                (c, k) => c.Value.GeoRadiusAsync(k, longitude, latitude, radius, unit, count, sorting, false, true,
                    false))).Select(a => (a.member, a.dist)).ToArray();
        ...
        /// <param name="sorting">排序</param>
        /// <returns></returns>
        async public Task<(T member, decimal dist)[]> GeoRadiusWithDistAsync<T>(string key, decimal longitude,
            decimal latitude, decimal radius, GeoUnit unit = GeoUnit.m, long? count = null,
            GeoOrderBy? sorting = null) =>
            (await ExecuteScalarAsync(key,
        ...
        async private Task<(string member, decimal longitude, decimal latitude)[]> GeoRadiusWithCoordAsync(string key,
            ...
            GeoOrderBy? sorting = null) =>
            (await ExecuteScalarAsync(key,
                (c, k) => c.Value.GeoRadiusAsync(k, longitude, latitude, radius, unit, count, sorting, true, false,
                    false))).Select(a => (a.member, a.longitude, a.latitude)).ToArray();
        ...
        async private Task<(T member, decimal longitude, decimal latitude)[]> GeoRadiusWithCoordAsync<T>(string key,
            ...
            GeoOrderBy? sorting = null) =>
            (await ExecuteScalarAsync(key,
                (c, k) => c.Value.GeoRadiusBytesAsync(k, longitude, latitude, radius, unit, count, sorting, true, false,
        ...
        async public Task<(string member, decimal dist, decimal longitude, decimal latitude)[]>
            ...
            (await ExecuteScalarAsync(key,
                (c, k) => c.Value.GeoRadiusAsync(k, longitude, latitude, radius, unit, count, sorting, true, true,
                    false))).Select(a => (a.member, a.dist, a.longitude, a.latitude)).ToArray();
        ...
        /// <param name="sorting">排序</param>
        /// <returns></returns>
        async public Task<(T member, decimal dist, decimal longitude, decimal latitude)[]>
        ...
        /// <param name="sorting">排序</param>
        /// <returns></returns>
        async public Task<string[]> GeoRadiusByMemberAsync(string key, object member, decimal radius,
            GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null) =>
            (await ExecuteScalarAsync(key,
                (c, k) => c.Value.GeoRadiusByMemberAsync(k, member, radius, unit, count, sorting, false, false, false)))
        ...
        /// <param name="sorting">排序</param>
        /// <returns></returns>
        async public Task<T[]> GeoRadiusByMemberAsync<T>(string key, object member, decimal radius,
            GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null) =>
            (await ExecuteScalarAsync(key,
                (c, k) => c.Value.GeoRadiusBytesByMemberAsync(k, member, radius, unit, count, sorting, false, false,
        ...
        /// <param name="sorting">排序</param>
        /// <returns></returns>
        async public Task<(string member, decimal dist)[]> GeoRadiusByMemberWithDistAsync(string key, object member,
            decimal radius, GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null) =>
            (await ExecuteScalarAsync(key,
                (c, k) => c.Value.GeoRadiusByMemberAsync(k, member, radius, unit, count, sorting, false, true, false)))
        ...
        /// <param name="sorting">排序</param>
        /// <returns></returns>
        async public Task<(T member, decimal dist)[]> GeoRadiusByMemberWithDistAsync<T>(string key, object member,
            decimal radius, GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null) =>
            (await ExecuteScalarAsync(key,
        ...
        /// <param name="sorting">排序</param>
        /// <returns></returns>
        async private Task<(string member, decimal longitude, decimal latitude)[]> GeoRadiusByMemberWithCoordAsync(
            string key, object member, decimal radius, GeoUnit unit = GeoUnit.m, long? count = null,
            GeoOrderBy? sorting = null) =>
            (await ExecuteScalarAsync(key,
                (c, k) => c.Value.GeoRadiusByMemberAsync(k, member, radius, unit, count, sorting, true, false, false)))
        ...
        /// <param name="sorting">排序</param>
        /// <returns></returns>
        async private Task<(T member, decimal longitude, decimal latitude)[]> GeoRadiusByMemberWithCoordAsync<T>(
            string key, object member, decimal radius, GeoUnit unit = GeoUnit.m, long? count = null,
            GeoOrderBy? sorting = null) =>
            (await ExecuteScalarAsync(key,
                (c, k) => c.Value.GeoRadiusBytesByMemberAsync(k, member, radius, unit, count, sorting, true, false,
                    false))).Select(a => (this.DeserializeRedisValueInternal<T>(a.member), a.longitude, a.latitude))
            .ToArray();
        ...
        async public Task<(string member, decimal dist, decimal longitude, decimal latitude)[]>
            ...
            (await ExecuteScalarAsync(key,
                (c, k) => c.Value.GeoRadiusByMemberAsync(k, member, radius, unit, count, sorting, true, true, false)))
