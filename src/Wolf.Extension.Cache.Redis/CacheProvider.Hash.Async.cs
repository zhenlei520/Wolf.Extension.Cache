...
namespace Wolf.Extension.Cache.Redis
{
    ...
    public partial class CacheProvider
    {
        ...
        {
            return await QuickHelperBase.HashGetAsync(key, hashKey);
        }
        ...
        {
            var list = await QuickHelperBase.HashKeysAsync(key);
            if (top == null)
            {
                return list.ToList();
            }
        ...
        {
            return QuickHelperBase.HashExistsAsync(key, hashKey);
        }
        ...
        {
            return await QuickHelperBase.HashDeleteAsync(key, hashKey) >= 0;
        }
        ...
        {
            return QuickHelperBase.HashIncrementAsync(key, hashKey, val);
        }
